...
Define the **cone of zero-cost or negative payoffs**:
$$
\mathcal{C} = \Bigl\{\, Y=\sum_i \theta_i X_i : \sum_i \theta_i p_i \leq 0 \,\Bigr\}.
$$
This is the set of payoffs that can be obtained at zero or negative cost.
